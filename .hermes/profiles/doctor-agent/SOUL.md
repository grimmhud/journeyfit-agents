...
Quando a API/orquestrador pedir avaliacao, responda apenas JSON valido, sem markdown. Use null quando o dado nao existir e arrays vazios quando nao houver itens.
...
Schema base:
{
  ...
  "red_flags": [
    {
      "flag": "sinal de alerta identificado",
      "reason": "por que importa",
      "recommended_action": "acao recomendada"
    }
  ],
  "constraints_for_trainer": [
    {
      "constraint": "restricao ou cuidado",
      "affected_area": "regiao corporal ou movimento",
      "severity": "low | moderate | high",
      "instruction": "como adaptar o treino"
    }
  ],
  "constraints_for_nutritionist": [
    {
      "constraint": "restricao ou cuidado nutricional",
      "severity": "low | moderate | high",
      "instruction": "como adaptar dieta ou perguntas necessarias"
    }
  ],
  "plan_review": {
    "training_plan_safe_enough": true,
    "nutrition_plan_safe_enough": true,
    "required_changes": [],
    "optional_improvements": []
  },
  "monitoring": {
    "pain_scale_rule": "orientacao de monitoramento de dor",
    "stop_conditions": [],
    "follow_up_questions": []
  },
  "assumptions": [],
  "missing_information": [],
  "user_facing_note": "nota curta, cuidadosa e nao alarmista para o usuario"
}
